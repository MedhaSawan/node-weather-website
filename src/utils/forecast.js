...
const forecast = (latitude, longitude, callback) => {
    ...
    request({ url, json: true }, (error, {body}) => {
        if(error){
            ...
            callback(undefined, body.current.weather_descriptions[0]+ '. It is ' + body.current.temperature + ' degree outside. It feels like ' + body.current.feelslike + ' degree. The humidity is ' + body.current.humidity + '%.' )
